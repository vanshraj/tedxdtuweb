...
<body>
	<section class="about-theme">
		<div class="head-title">ABOUT THEME</div>
		<div class="head-theme">
			<a href="http://theme.tedxdtu.in">
				<p>BECAUSE GREY MATTERS</p>
			</a>
		</div>
	...
	<section class="intro">
		<div class="intro-text-wrapper animation">
			<p>Envisage a society inclusive of every shade,<br>Let in the light, witness the extremities fade,</p>
			<p>We are a contrast of extravagance and subsistence,<br>Ideas are born out of necessity and persistence,</p>
			<p>Conditions of birth and death fail to decide your fate,<br>Break free from the reigns of stereotype, prejudice and hate,</p>
			<p>Observe the world under a new lens,<br>Focus on the greys, for black and white hardly make sense,</p>
			<p>For black and white are hardly pristine,<br>Pristine is their blending,</p>
			<p>Blend-o-blend, till there are polarities no more,<br>More we absorb, higher the ladder we climb.</p>
		</div>
	</section>
	<a href="http://www.ted.com/tedx/events/20506">
		<div class="logo"><img src="./img/logo.png"></div>
	</a>
	<div class="next"><button class="next-button">NEXT</button></div>
	<div class="skip"><button class="skip-button">SKIP</button></div>
	<!-- </div> -->
</body>
